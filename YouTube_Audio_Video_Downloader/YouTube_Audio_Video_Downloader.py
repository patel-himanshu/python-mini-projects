...
def audio_video_download(yt): # Takes YouTube object as input
    ...
    print()
    stream_num = int(input('Select the serial number, in which you want to download the media: '))
...
if __name__ == '__main__':
    ...
    for _ in range(num_videos):
        ...
        if (video_availability==1 and audio_availability==1):
            print('Available options (All in .mp4 format only): [1] Audio-Video  [2] Audio Only  [3] Video Only')
